...
- [Defanging an Ip address](https://leetcode.com/problems/defanging-an-ip-address/) yes
- [Shuffle String](https://leetcode.com/problems/shuffle-string/)  yes (did usng the Stringbuilder and char)
...
- [Valid Parentheses](https://leetcode.com/problems/valid-parentheses/) this need to be done usinmg the stack because it can be consecutive 
- [Length of last word](https://leetcode.com/problems/length-of-last-word/) yes
