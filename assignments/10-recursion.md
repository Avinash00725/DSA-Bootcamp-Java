...
- [Binary Search using recursion](https://leetcode.com/problems/binary-search/) `leetcode`   yes
...
- [Reverse String](https://leetcode.com/problems/reverse-string/) `leetcode`  yes
- [Print 1 To N Without Loop](https://practice.geeksforgeeks.org/problems/print-1-to-n-without-using-loops-1587115620/1/) `GFG`
- [Fibonacci Number](https://leetcode.com/problems/fibonacci-number/) `leetcode`  yes
...
- [Power of Two](https://leetcode.com/problems/power-of-two/) `leetcode` yes
