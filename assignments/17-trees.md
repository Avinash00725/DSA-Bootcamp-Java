...
- [Binary Tree Inorder Traversal](https://leetcode.com/problems/binary-tree-inorder-traversal/) `leetcode` yes
- [Same Tree](https://leetcode.com/problems/same-tree/) `leetcode` yes
- [Symmetric Tree](https://leetcode.com/problems/symmetric-tree/) `leetcode` yes
- [Maximum Depth of Binary Tree](https://leetcode.com/problems/maximum-depth-of-binary-tree/) `leetcode` yes
...
- [Balanced Binary Tree](https://leetcode.com/problems/balanced-binary-tree/) `leetcode` yes
- [Minimum Depth of Binary Tree](https://leetcode.com/problems/minimum-depth-of-binary-tree/) `leetcode` yes
- [Path Sum](https://leetcode.com/problems/path-sum/) `leetcode`
- [Binary Tree Preorder Traversal](https://leetcode.com/problems/binary-tree-preorder-traversal/) `leetcode`yes
- [Binary Tree Postorder Traversal](https://leetcode.com/problems/binary-tree-postorder-traversal/) `leetcode`yes
- [Invert Binary Tree](https://leetcode.com/problems/invert-binary-tree/) `leetcode`yes
- [Binary Tree Paths](https://leetcode.com/problems/binary-tree-paths/) `leetcode`
- [Sum of Left Leaves](https://leetcode.com/problems/sum-of-left-leaves/) `leetcode`yes
...
- [Diameter of Binary Tree](https://leetcode.com/problems/diameter-of-binary-tree/) `leetcode`yes
